...
window.SCENES = {
  ...
  hollow: {
    ...
    use: {
      ...
      parchment: "Thou breakest thy father's seal at last. The wax cracks like winter ice. The hand within is older and more tremulous than thou rememberest, yet unmistakably thine own father's — 'Aric — if thou readest this, I have been called back to the mountain. I am not myself. I fear I will not return. The ORDER OF DAWN is not what they told thee. Thy brothers obey CHANCELLOR VALEN, not the King. Trust no tabard. Trust no command issued in his name. — Your Father, Edmund.'",
