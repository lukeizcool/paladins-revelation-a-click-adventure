...
window.SCENES = {
  ...
  hollow: {
    ...
    use: {
      ...
      parchment: "Thou breakest thy father's seal at last. The letter reads: 'Aric — if thou readest this, I have been called back to the mountain. I am not what I seemed. I am not even WHAT I seemed. Do not raise steel against the Wyrm of Skar'Vael. The wyrm is thy father. — Cael.'",
